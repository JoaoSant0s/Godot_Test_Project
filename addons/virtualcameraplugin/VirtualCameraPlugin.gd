...
func _enter_tree():
	...
	add_custom_type(MAIN_CAMERA_NAME, "Camera3D", preload("VirtualCamera/Runtime/MainCamera.gd"), preload("camera-main.svg"))
	add_custom_type(VIRTUAL_CAMERA_NAME, "Node3D", preload("VirtualCamera/Runtime/VirtualCamera.gd"), preload("camera-virtual.svg"))
